...
class TopicViewControllerTests: XCTestCase {
  ...
  private let topic = Topic(title: "Foo", type: .physics_formulas)
...
extension TopicViewControllerTests {
  ...
  class MockTopicDataSource : TopicDataSourceProtocol {
    ...
    init(numberOfSections: Int = 1, numberOfRows: Int = 0, topicToReturn: Topic = Topic(title: "Foo", type: .physics_formulas)) {
