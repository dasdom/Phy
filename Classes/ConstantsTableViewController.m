...
- (void)viewDidLoad {
    ...
    @[
        ...
        [[CalculatorConstant alloc] initWithName:NSLocalizedString(@"molares Volumen idealer Gase", @"") value:@"22.413996" unit:@"dm³ mol⁻¹"],
        ...
        [[CalculatorConstant alloc] initWithName:NSLocalizedString(@"Boltzmann-Konstante", @"") value:@"1.3806503e-23" unit:@"J K⁻¹"],
        ...
        [[CalculatorConstant alloc] initWithName:NSLocalizedString(@"Lichtgeschwindigkeit im Vakuum", @"") value:@"2.99792458e8" unit:@"m s⁻¹"],
        [[CalculatorConstant alloc] initWithName:NSLocalizedString(@"Stefan-Boltzmann-Konstante", @"") value:@"5.670400e-8" unit:@"W m⁻² K⁻⁴"],
        ...
        [[CalculatorConstant alloc] initWithName:NSLocalizedString(@"Ruhemasse des Proton", @"") value:@"1.67262158e-27" unit:@"kg"],
        [[CalculatorConstant alloc] initWithName:NSLocalizedString(@"Ruhemasse des Neutron", @"") value:@"1.67492716e-27" unit:@"kg"],
        ...
        [[CalculatorConstant alloc] initWithName:NSLocalizedString(@"Feinstrukturkonstante", @"") value:@"7.297352533e-3" unit:@""],
