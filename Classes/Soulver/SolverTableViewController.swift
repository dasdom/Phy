...
class SolverTableViewController: UITableViewController {
  ...
  override func viewDidLoad() {
    ...
    tableView.register(NameAndFormulaImageTableViewCell.self, forCellReuseIdentifier: NameAndFormulaImageTableViewCell.identifier)
  ...
  override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
    ...
    guard let cell = tableView.dequeueReusableCell(withIdentifier: NameAndFormulaImageTableViewCell.identifier, for: indexPath) as? NameAndFormulaImageTableViewCell else {
