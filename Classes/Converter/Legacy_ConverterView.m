...
- (id)initWithFrame:(CGRect)frame {
    if ((self = [super initWithFrame:frame])) {
        ...
        _inputValue.keyboardType = UIKeyboardTypeDecimalPad;
        [_inputValue setTextAlignment: NSTextAlignmentRight];
        _inputValue.textAlignment = NSTextAlignmentRight;
        
        UIToolbar *toolbar = [[UIToolbar alloc] initWithFrame:CGRectMake(0, 0, 0, 44)];
        
        toolbar.items =
        @[
          [[UIBarButtonItem alloc] initWithTitle:@"e" style:UIBarButtonItemStylePlain target:nil action:@selector(insertE:)],
          [[UIBarButtonItem alloc] initWithTitle:@"-" style:UIBarButtonItemStylePlain target:nil action:@selector(insertMinus:)],
